...
$(document).ready(function () {
        ...
        //validator to check emailId is unique or not
          ...
          if(!navigator.onLine) swal("You are offline", "", "info");
            ...
            //validate to check houseNo has owner or not already
            $.validator.addMethod("haveOwner", function (value) {
                var data = { house: value };
                //console.log(JSON.stringify(data));
                var found = $.ajax({
                        type: "POST",
                        contentType: "application/json",
                        async: false,
                        data: {},
                        url: urlbase + "owner/checkHouse/" + data.house,
                        datatype: "json",
                        success: function (data) {
                            return data;
                        },
            ...
            $("#registerOwner").validate({
                ...
                messages: {
                    ...
                    // ,
                    // house: {
                    //     required: "Please provide your HouseNo"
                    // }
